...
public class CroptopiaWorldBiomeSelection {
    ...
    public CroptopiaWorldBiomeSelection(BootstrapContext<BiomeModifier> context) {
        ...
        new BiomeMod(context, biomes, placedFeatures, COFFEE_BEANS_CROP_PLACED_KEY, ADD_CHILE_PEPPER_CROP_TO_BIOMES, HAS_CHILE_PEPPER);
        new BiomeMod(context, biomes, placedFeatures, CORN_CROP_PLACED_KEY, ADD_COFFEE_BEANS_CROP_TO_BIOMES, HAS_COFFEE_BEANS);
        new BiomeMod(context, biomes, placedFeatures, CRANBERRY_CROP_PLACED_KEY, ADD_CORN_CROP_TO_BIOMES, HAS_CORN);
        new BiomeMod(context, biomes, placedFeatures, CUCUMBER_CROP_PLACED_KEY, ADD_CRANBERRY_CROP_TO_BIOMES, HAS_CRANBERRY);
        new BiomeMod(context, biomes, placedFeatures, CURRANT_CROP_PLACED_KEY, ADD_CUCUMBER_CROP_TO_BIOMES, HAS_CUCUMBER);
        new BiomeMod(context, biomes, placedFeatures, EGGPLANT_CROP_PLACED_KEY, ADD_CURRANT_CROP_TO_BIOMES, HAS_CURRANT);
        new BiomeMod(context, biomes, placedFeatures, ELDERBERRY_CROP_PLACED_KEY, ADD_EGGPLANT_CROP_TO_BIOMES, HAS_EGGPLANT);
        new BiomeMod(context, biomes, placedFeatures, GARLIC_CROP_PLACED_KEY, ADD_ELDERBERRY_CROP_TO_BIOMES, HAS_ELDERBERRY);
        new BiomeMod(context, biomes, placedFeatures, GINGER_CROP_PLACED_KEY, ADD_GARLIC_CROP_TO_BIOMES, HAS_GARLIC);
        new BiomeMod(context, biomes, placedFeatures, GRAPE_CROP_PLACED_KEY, ADD_GINGER_CROP_TO_BIOMES, HAS_GINGER);
        new BiomeMod(context, biomes, placedFeatures, GREENBEAN_CROP_PLACED_KEY, ADD_GRAPE_CROP_TO_BIOMES, HAS_GRAPE);
        new BiomeMod(context, biomes, placedFeatures, GREENONION_CROP_PLACED_KEY, ADD_GREENBEAN_CROP_TO_BIOMES, HAS_GREENBEAN);
        new BiomeMod(context, biomes, placedFeatures, HONEYDEW_CROP_PLACED_KEY, ADD_GREENONION_CROP_TO_BIOMES, HAS_GREENONION);
        new BiomeMod(context, biomes, placedFeatures, HOPS_CROP_PLACED_KEY, ADD_HONEYDEW_CROP_TO_BIOMES, HAS_HONEYDEW);
        new BiomeMod(context, biomes, placedFeatures, KALE_CROP_PLACED_KEY, ADD_HOPS_CROP_TO_BIOMES, HAS_HOPS);
        new BiomeMod(context, biomes, placedFeatures, KIWI_CROP_PLACED_KEY, ADD_KALE_CROP_TO_BIOMES, HAS_KALE);
        new BiomeMod(context, biomes, placedFeatures, LEEK_CROP_PLACED_KEY, ADD_KIWI_CROP_TO_BIOMES, HAS_KIWI);
        new BiomeMod(context, biomes, placedFeatures, LETTUCE_CROP_PLACED_KEY, ADD_LEEK_CROP_TO_BIOMES, HAS_LEEK);
        new BiomeMod(context, biomes, placedFeatures, MUSTARD_CROP_PLACED_KEY, ADD_LETTUCE_CROP_TO_BIOMES, HAS_LETTUCE);
        new BiomeMod(context, biomes, placedFeatures, OAT_CROP_PLACED_KEY, ADD_MUSTARD_CROP_TO_BIOMES, HAS_MUSTARD);
        new BiomeMod(context, biomes, placedFeatures, OLIVE_CROP_PLACED_KEY, ADD_OAT_CROP_TO_BIOMES, HAS_OAT);
        new BiomeMod(context, biomes, placedFeatures, ONION_CROP_PLACED_KEY, ADD_OLIVE_CROP_TO_BIOMES, HAS_OLIVE);
        new BiomeMod(context, biomes, placedFeatures, PEANUT_CROP_PLACED_KEY, ADD_ONION_CROP_TO_BIOMES, HAS_ONION);
        new BiomeMod(context, biomes, placedFeatures, CHILE_PEPPER_CROP_PLACED_KEY, ADD_PEANUT_CROP_TO_BIOMES, HAS_PEANUT);
        new BiomeMod(context, biomes, placedFeatures, PINEAPPLE_CROP_PLACED_KEY, ADD_PEPPER_CROP_TO_BIOMES, HAS_PEPPER);
        new BiomeMod(context, biomes, placedFeatures, RADISH_CROP_PLACED_KEY, ADD_PINEAPPLE_CROP_TO_BIOMES, HAS_PINEAPPLE);
        new BiomeMod(context, biomes, placedFeatures, RASPBERRY_CROP_PLACED_KEY, ADD_RADISH_CROP_TO_BIOMES, HAS_RADISH);
        new BiomeMod(context, biomes, placedFeatures, RHUBARB_CROP_PLACED_KEY, ADD_RASPBERRY_CROP_TO_BIOMES, HAS_RASPBERRY);
        new BiomeMod(context, biomes, placedFeatures, RICE_CROP_PLACED_KEY, ADD_RHUBARB_CROP_TO_BIOMES, HAS_RHUBARB);
        new BiomeMod(context, biomes, placedFeatures, RUTABAGA_CROP_PLACED_KEY, ADD_RICE_CROP_TO_BIOMES, HAS_RICE);
        new BiomeMod(context, biomes, placedFeatures, SAGUARO_CROP_PLACED_KEY, ADD_RUTABAGA_CROP_TO_BIOMES, HAS_RUTABAGA);
        new BiomeMod(context, biomes, placedFeatures, SOYBEAN_CROP_PLACED_KEY, ADD_SAGUARO_CROP_TO_BIOMES, HAS_SAGUARO);
        new BiomeMod(context, biomes, placedFeatures, SPINACH_CROP_PLACED_KEY, ADD_SOYBEAN_CROP_TO_BIOMES, HAS_SOYBEAN);
        new BiomeMod(context, biomes, placedFeatures, SQUASH_CROP_PLACED_KEY, ADD_SPINACH_CROP_TO_BIOMES, HAS_SPINACH);
        new BiomeMod(context, biomes, placedFeatures, STRAWBERRY_CROP_PLACED_KEY, ADD_SQUASH_CROP_TO_BIOMES, HAS_SQUASH);
        new BiomeMod(context, biomes, placedFeatures, SWEETPOTATO_CROP_PLACED_KEY, ADD_STRAWBERRY_CROP_TO_BIOMES, HAS_STRAWBERRY);
        new BiomeMod(context, biomes, placedFeatures, TOMATILLO_CROP_PLACED_KEY, ADD_SWEETPOTATO_CROP_TO_BIOMES, HAS_SWEETPOTATO);
        new BiomeMod(context, biomes, placedFeatures, TOMATO_CROP_PLACED_KEY, ADD_TEA_LEAVES_CROP_TO_BIOMES, HAS_TEA_LEAVES);
        new BiomeMod(context, biomes, placedFeatures, TURMERIC_CROP_PLACED_KEY, ADD_TOMATILLO_CROP_TO_BIOMES, HAS_TOMATILLO);
        new BiomeMod(context, biomes, placedFeatures, TURNIP_CROP_PLACED_KEY, ADD_TOMATO_CROP_TO_BIOMES, HAS_TOMATO);
        new BiomeMod(context, biomes, placedFeatures, YAM_CROP_PLACED_KEY, ADD_TURMERIC_CROP_TO_BIOMES, HAS_TURMERIC);
        new BiomeMod(context, biomes, placedFeatures, ZUCCHINI_CROP_PLACED_KEY, ADD_TURNIP_CROP_TO_BIOMES, HAS_TURNIP);
        new BiomeMod(context, biomes, placedFeatures, VANILLA_CROP_PLACED_KEY, ADD_VANILLA_CROP_TO_BIOMES, HAS_VANILLA);
        new BiomeMod(context, biomes, placedFeatures, PEPPER_CROP_PLACED_KEY, ADD_YAM_CROP_TO_BIOMES, HAS_YAM);
        new BiomeMod(context, biomes, placedFeatures, TEA_LEAVES_CROP_PLACED_KEY, ADD_ZUCCHINI_CROP_TO_BIOMES, HAS_ZUCCHINI);
